...
import { createAwardAsync } from "./thunks";
import {
...
export const awardsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    // // CreateActor
    // .addCase(createAwardAsync.pending, getAwardsPendingCaseReducer)
    // .addCase(createAwardAsync.fulfilled, getAwardsFulfilledCaseReducer)
    // .addCase(createAwardAsync.rejected, getAwardsRejectedCaseReducer)
  },
});
